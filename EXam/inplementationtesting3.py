...
# Filtersectie
tk.Label(root, text="Filter op Merk").grid(row=7, column=0)
filter_merk_combobox = ttk.Combobox(root)
filter_merk_combobox.grid(row=7, column=1)

tk.Label(root, text="Filter op Type").grid(row=8, column=0)
filter_type_combobox = ttk.Combobox(root, values=["Shirt", "Sweater", "Jas", "Broek", "Trui", "Vest"])
filter_type_combobox.grid(row=8, column=1)

tk.Label(root, text="Filter op Maat").grid(row=9, column=0)
filter_maat_combobox = ttk.Combobox(root, values=["XS", "S", "M", "L", "XL", "XXL"])
filter_maat_combobox.grid(row=9, column=1)

tk.Label(root, text="Filter op Hoeveelheid").grid(row=10, column=0)
filter_hoeveelheid_combobox = ttk.Combobox(root, values=[str(i) for i in range(1, 11)])
filter_hoeveelheid_combobox.grid(row=10, column=1)

# Knop om filters toe te passen
filter_knop = tk.Button(root, text="Pas Filter Toe", command=update_lijst)
filter_knop.grid(row=11, column=0, columnspan=2, pady=10)
...
exporteer_knop.grid(row=12, column=0, columnspan=2, pady=10)
...
exporteer_sql_knop.grid(row=13, column=0, columnspan=2, pady=10)
